...
<div id="mySidenav" class="sidenav text-center">
 ...
 -->
	...
	<form action="${pageContext.request.contextPath}/testgiven2" method="post">
		...
		<div id="test"></div>
		<input type='hidden' id="score" name="module2_score" value='' />
...
function renderQuestion(){
	...
	if(pos >= questions.length){
		test.innerHTML = "";
		_("test_status").innerHTML = "<h2>Thankyou, Module 2 is complete</h2>";
		/* pos = 0; */
/* 		correct = 0; */
		return false;
	}
