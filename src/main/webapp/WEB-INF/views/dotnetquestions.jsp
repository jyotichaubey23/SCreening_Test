...
<body>
	<div class="container register-body">
		<div class="row login">
			<div class="col-md-12  mx-auto m-4">
				<div class="jumbotron">
					<h1 class="text-center">DotNet Questions</h1>
					<br /> <br />
	...
	<script type="text/javascript" src="<c:url value = "${pageContext.request.contextPath}/js/bootstarp.js"/>"></script>
	<script type="text/javascript" src="<c:url value = "${pageContext.request.contextPath}/js/jquery.js"/>"></script>
</body>
</html>