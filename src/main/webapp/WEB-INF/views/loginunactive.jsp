...
<title>Inactive Candidates</title>
		...
		<div class=" text-center mt-3 "
			...
			<div class="btn btn-danger p-3">
					<a href="${pageContext.request.contextPath}/viewemp/1"
						class="float-right" style="color:white;">Candidate List</a>
				</div>
				<div class="btn btn-danger p-3">
					<a href="${pageContext.request.contextPath}/inact/1"
						class="float-right" style="color:white;">Pending Candidates</a>
				</div>
				<div class="btn btn-danger p-3">
					<a href="${pageContext.request.contextPath}/enable/1"
						class="float-right" style="color:white;">Test Active Candidates</a>
				</div>
				<div class="btn btn-danger p-3">
					<a href="${pageContext.request.contextPath}/unable/1"
						class="float-right" style="color:white;">Test Inactive Candidates</a>
				</div>
			</div>
		</div>
		<br /> <br />
			...
			<tbody>
				<c:forEach items="${msg}" var="User">
					<tr onmouseover="ChangeColor(this, true);"
						...
						<td><a href="<c:url value='/inact/edit/${User.id }' />">Edit</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
